...
class priceModels{
    ...
    public function __construct($product_id,$price_color,$price,$detail,$quantity,$qtyp_id)
    {
    ...
    public static function get($product_id)
    {
        ...
        return new priceModels($product_id,$price_color,$price,$detail,$quantity,$qtyp_id);
    }
    ...
    public static function getAll()
    {
        $pricemodelsList = [];
        require("connection_connect.php");
        $sql = "SELECT product_id,price_color,price,detail,quantity FROM Quantity";
        $result = $conn->query($sql);
        while($my_row = $result->fetch_assoc())
        {
            ...
            $qtyp_id = $my_row[qtyp_id];
            $pricemodelsList[] = new priceModels($product_id,$price_color,$price,$detail,$quantity,$qtyp_id);
        }
        require("connection_close.php");
    ...
    public static function search($key)
    {
        ...
        price like '%$key%' or detail like '%$key%' or quantity like '%$key%' or qtyp_id like '%$qtyp_id%')";
        $result = $conn->query($sql);
        while($my_row = $result->fetch_assoc())
        {
    ...
    public static function add($product_id,$price_color,$price,$detail,$quantity,$qtyp_id)
    {
        require("connection_connect.php");
        $sql = "INSERT INTO Quantity(product_id,price_color,price,detail,quantity,qtyp_id) values 
        ('product_id','price_color','price','detail','quantity','qtyp_id')";
        $result = $conn->query($sql);
        require("connect_cloes.php");
        return "add success $result rows";
    }

    public static function update($product_id,$price_color,$price,$detail,$quantity,$qtyp_id)
    {
        require("connection_connect.php");
